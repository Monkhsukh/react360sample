...
export default class card extends React.Component {
    ...
    cli = (s) =>{
        if(this.state.before==10){
            this.putbefore(s)
            this.putbeforeS(s)
        }else{
            if(this.state.before==this.getvalue(s)){
    ...
    render () {
        ...
        return (
            <View style={styles.panel}>
                <Text style={styles.title}>{this.state.win?'You win!':'Memory flop game!'}</Text>

                <VrButton onClick={() => this.change(1)} style={styles.BeginButton}>
                    {this.state.s1 ?<Image source={asset(this.state.i1+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(2)} style={styles.BeginButton}>
                    {this.state.s2 ?<Image source={asset(this.state.i2+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(3)} style={styles.BeginButton}>
                    {this.state.s3 ?<Image source={asset(this.state.i3+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(4)} style={styles.BeginButton}>
                    {this.state.s4 ?<Image source={asset(this.state.i4+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>

                {/*<VrButton onClick={() => this.change(5)} style={styles.BeginButton}>
                    {this.state.s5 ?<Image source={asset(this.state.i5+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(6)} style={styles.BeginButton}>
                    {this.state.s6 ?<Image source={asset(this.state.i6+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(7)} style={styles.BeginButton}>
                    {this.state.s7 ?<Image source={asset(this.state.i7+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(8)} style={styles.BeginButton}>
                    {this.state.s8 ?<Image source={asset(this.state.i8+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(9)} style={styles.BeginButton}>
                    {this.state.s9 ?<Image source={asset(this.state.i9+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(10)} style={styles.BeginButton}>
                    {this.state.s10 ?<Image source={asset(this.state.i10+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(11)} style={styles.BeginButton}>
                    {this.state.s11 ?<Image source={asset(this.state.i11+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(12)} style={styles.BeginButton}>
                    {this.state.s12 ?<Image source={asset(this.state.i12+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(13)} style={styles.BeginButton}>
                    {this.state.s13 ?<Image source={asset(this.state.i13+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(14)} style={styles.BeginButton}>
                    {this.state.s14 ?<Image source={asset(this.state.i14+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(15)} style={styles.BeginButton}>
                    {this.state.s15 ?<Image source={asset(this.state.i15+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
                </VrButton>
                <VrButton onClick={() => this.change(16)} style={styles.BeginButton}>
                    {this.state.s16 ?<Image source={asset(this.state.i16+'.jpg')} style={styles.levelButton}/>:
                    <Image source={asset('all.jpg')} style={styles.levelButton}/>}
        </VrButton>*/}
            </View>
